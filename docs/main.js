...
/******/ (() => {
  ...
  \**********************/
      /***/ (
        ...
        eval(
          '__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ "./src/style.css");\n/* harmony import */ var _buildingPage_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./buildingPage.js */ "./src/buildingPage.js");\n\n\n\n\n(0,_buildingPage_js__WEBPACK_IMPORTED_MODULE_1__.settingCoordinat)();\n(0,_buildingPage_js__WEBPACK_IMPORTED_MODULE_1__.loadButtons)();\n\n//# sourceURL=webpack://lesson7/./src/index.js?',
        );
  ...
  \*******************************/
      /***/ (
        ...
        eval(
          "__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   clearAllCookies: () => (/* binding */ clearAllCookies),\n/* harmony export */   deleteCookieWithValue: () => (/* binding */ deleteCookieWithValue),\n/* harmony export */   getCookieValuesWithButton: () => (/* binding */ getCookieValuesWithButton),\n/* harmony export */   setCookie: () => (/* binding */ setCookie)\n/* harmony export */ });\n/* eslint-disable no-unused-vars */\r\n/* eslint-disable no-const-assign */\r\n/* eslint-disable no-undef */\r\n\r\nfunction setCookie(name, value) {\r\n    const cookieString = `${name}_${new Date().getTime()}=${value};`;\r\n    document.cookie = cookieString;\r\n}\r\n\r\nfunction deleteCookieWithValue(value) {\r\n    const cookies = document.cookie.split(';');\r\n    for (let i = 0; i < cookies.length; i++) {\r\n      const cookie = cookies[i].trim();\r\n      const [cookieName, cookieValue] = cookie.split('=');\r\n      if (cookieValue === value) {\r\n        document.cookie = `${cookieName}=; expires=Thu, 01 Jan 1970 00:00:00 GMT;`;\r\n      }\r\n    }\r\n}\r\n\r\nfunction getCookieValuesWithButton() {\r\n    const cookies = document.cookie.split(';');\r\n    const buttonCookies = [];\r\n    for (let i = 0; i < cookies.length; i++) {\r\n      const cookie = cookies[i].trim();\r\n      const [cookieName, cookieValue] = cookie.split('=');\r\n      if (cookieName.includes('button')) {\r\n        buttonCookies.push(cookieValue);\r\n      }\r\n    }\r\n    return buttonCookies;\r\n}\r\n\r\nfunction clearAllCookies(buttons) {\r\n    const cookies = document.cookie.split(';');\r\n    for (let i = 0; i < cookies.length; i++) {\r\n      const cookie = cookies[i].trim();\r\n      const [cookieName] = cookie.split('=');\r\n      document.cookie = `${cookieName}=; expires=Thu, 01 Jan 1970 00:00:00 GMT;`;\r\n    }\r\n  }\r\n\n\n//# sourceURL=webpack://lesson7/./src/workingCookies.js?",
        );
